...
function showStories() {
    ...
    html += `
              <div class="noteCard my-2 mx-2 card" style="width: 18rem;">
                      <div class="card-body">
                          ...
                          <button id="${index}"onclick="deleteStory(this.id)" class="btn btn-primary">Task complete</button>
                      </div>
                  </div>`;
  });
  ...
  if (storiesObj.length != 0) {
    ...
    storiesElm.innerHTML = `No tasks recorded! Use the "Add task" button above to add to your to-do list!.`;
  }
}
